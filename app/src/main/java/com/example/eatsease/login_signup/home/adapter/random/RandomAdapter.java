package com.example.eatsease.login_signup.home.adapter.random;
...
public class RandomAdapter extends RecyclerView.Adapter<RandomAdapter.RandomViewHolder> {
    ...
    public RandomAdapter(Context context) {
        ...
        this.homeRepo = new HomeRepo(); // Initialize the HomeRepo
    ...
    private void fetchRandomMeal() {
        compositeDisposable.add(homeRepo.getRandomMeal()
